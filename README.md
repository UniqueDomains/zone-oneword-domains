# Available .ZONE One-Word Domains (83,991)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-83%2C991%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **83,991 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 83,991 domains · **Median ask:** $17.00 · **High-demand under $2,500:** 283
...
| science.zone | premium   | $854      | $854          | medium         | medium | 7      | namesilo                                                           |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 83,991 live domains                        |
| Static CSV / JSON       | live search and daily refresh              |
| Basic exported fields   | 283 high-demand names under $2,500         |
...
> Unique Domains. *Available .ZONE One-Word Domains*. Version 2026-09-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
